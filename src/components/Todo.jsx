    ...
    renderDisplay() {
        return (
            <div className={`todo${this.props.completed ? ' completed' : ''}`}>
                ...
                <span className="todo-title"onDoubleClick={() => this.setState({ editing: true })}>{this.props.title}</span>
    ...
    renderForm() {
        return (
            <form className="todo-edit-form" onSubmit={this.handleSubmit}>
                <input type="text" ref="title"  onBlur={this.handleInputBlur} defaultValue={this.props.title} />
